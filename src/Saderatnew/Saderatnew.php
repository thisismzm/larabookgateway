...
namespace Larabookir\Gateway\Saderatnew;
...
class Saderatnew extends PortAbstract implements PortInterface
{
	/**
	 ...
	 * @var string
	 */
	protected $serverTokenUrl = 'https://mabna.shaparak.ir:8081/V1/PeymentApi/GetToken';
	...
	public function redirect()
	{
		...
		return \View::make('app.gateway.saderat-new-redirector')->with(compact('token', 'TerminalID'));
	}
